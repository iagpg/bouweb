  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      ...
      <div className="flex items-start gap-4 bg-surface-container-high p-6">
        ...
        <div>
          <p className="mb-1 text-1xl font-headline uppercase tracking-widest text-primary">
            Vendedores
          </p>
    ...
    <div className="flex items-start gap-4 bg-surface-container-high p-6">
        ...
        <div>
          ...
          <p className="text-sm text-on-surface-variant">Atendimento de Segunda a Sexta: 08:00 - 17:00</p>
        </div>
      </div>
